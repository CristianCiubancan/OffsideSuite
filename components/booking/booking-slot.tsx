  ...
  return selectedDate ? (
    todaysBookingsMap.has(interval) ? (
      ...
      <button
        ...
        className="drop-shadow-lg bg-yellow-300 h-24 text-left flex items-start gap-4 border-2 border-black rounded text-black cursor-pointer hover:bg-yellow-400"
      >
