      ...
      {!textarea ? (
        <div className="relative">
          <input
            ...
            className="block px-2.5 pb-2.5 pt-5 w-full text-sm text-white bg-red-700 border-0 border-b-2 border-white appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer"
            type={type ? type : "text"}
            id={name}
            placeholder=" "
          />
        ...
        <div className="relative">
          <textarea
            ...
            id={name}
            rows={4}
            className="block p-2.5 w-full text-sm text-white bg-red-700 rounded-lg border-2 border-white appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer"
            placeholder=" "
          ></textarea>
          <label
            htmlFor={name}
